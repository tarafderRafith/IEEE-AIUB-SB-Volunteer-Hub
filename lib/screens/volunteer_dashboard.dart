...
class _VolunteerDashboardState extends State<VolunteerDashboard> {
  ...
  DateTime? _getEventDateTime(
    ...
    try {
      ...
      debugPrint('❌ Event date parsing error: $e');
    }
  ...
  String _formatEventDate(
    ...
    if (dateTime == null) {
      final value = event['date']?.toString();
  ...
  String _formatTaskDeadline(
    ...
    final deadline = task['deadline']?.toString().trim();
  ...
  Widget build(BuildContext context) {
    final name = AuthService.fullName?.trim().isNotEmpty == true
      ...
      child: Row(
        children: [
          ...
          Container(
            ...
            height: 53,
            decoration: BoxDecoration(
              color: const Color(0xFF0D6EFD).withOpacity(0.13),
              borderRadius: BorderRadius.circular(17),
              border: Border.all(
                color: const Color(0xFF318DFF).withOpacity(0.25),
              ),
            ),
            child: const Icon(
            ...
            Row(
              children: [
                Container(
                  ...
                  height: 42,
                  decoration: BoxDecoration(
                    color: const Color(0xFF2388FF).withOpacity(0.14),
                    borderRadius: BorderRadius.circular(13),
                  ),
                  child: const Icon(
                    Icons.event_rounded,
                    color: Color(0xFF62ADFF),
                    size: 23,
                  ),
                ),
                const SizedBox(width: 12),
        ...
        children: [
          ...
          ClipRRect(
            ...
            child: LinearProgressIndicator(
              ...
              minHeight: 8,
              backgroundColor: const Color(0xFF15345D),
            ...
            GestureDetector(
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (_) => const VolunteerTasksScreen(),
                  ),
                );
              },
              child: const Text(
                ...
                Row(
                  children: [
                    ...
                    const Icon(
                      ...
                      color: Color(0xFF647F9E),
                      size: 11,
                    ),
                    const SizedBox(width: 4),
                    Expanded(
                      child: Text(
                        _formatTaskDeadline(task),
                        maxLines: 1,
                        overflow: TextOverflow.ellipsis,
                        style: const TextStyle(
                          color: Color(0xFF728CA9),
                          fontSize: 9,
                        ),
                      ),
                    ),
          ...
          children: [
            ...
            Expanded(
              child: _buildQuickCard(
                ...
                title: 'Points',
                value: completedPoints.toString(),
        ...
        GestureDetector(
          onTap: () {
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (_) => const VolunteerEventsScreen(),
              ),
            );
          },
          child: Container(
